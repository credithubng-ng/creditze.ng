          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Asset Finance</h3>
                <p className="text-gray-500 mb-6">Vehicles, equipment & more</p>
                <ul className="space-y-3 mb-8">
                  {[
                    'Car loans & motorcycles',
                    'Equipment financing',
                    'Flexible repayment',
                ...
                >
                  <a href="https://creditze.ng" target="_blank" rel="noopener noreferrer">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="bg-gradient-to-br from-purple-600 to-purple-700 rounded-3xl p-8 shadow-lg relative overflow-hidden"
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Home Improvement</h3>
                <p className="text-purple-100 mb-6">Renovate & upgrade your space</p>
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-purple-50">
                ...
                <Button 
                  asChild
                  className="w-full bg-white text-purple-600 hover:bg-purple-50 rounded-xl py-6"
                >
                  <a href="https://creditze.ng" target="_blank" rel="noopener noreferrer">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-3xl p-8 shadow-lg relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16" />
              <div className="relative">
                <div className="w-14 h-14 bg-white/20 rounded-2xl flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">Education Loan</h3>
                <p className="text-orange-100 mb-6">Invest in your future</p>
                <ul className="space-y-3 mb-8">
                  {[
                    'Tuition & school fees',
                    ...
                    <li key={i} className="flex items-center gap-3 text-orange-50">
                ...
                <Button 
                  asChild
                  className="w-full bg-white text-orange-600 hover:bg-orange-50 rounded-xl py-6"
                >
                  <a href="https://creditze.ng" target="_blank" rel="noopener noreferrer">
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Device Financing</h3>
                <p className="text-gray-500 mb-6">Get the latest gadgets now</p>
                <ul className="space-y-3 mb-8">
                  {[
                    'Smartphones & tablets',
                    'Laptops & computers',
                ...
                <Button 
                  asChild
                  className="w-full bg-indigo-600 hover:bg-indigo-700 rounded-xl py-6"
                >
                  <a href="https://creditze.ng" target="_blank" rel="noopener noreferrer">
                    Explore Devices <ArrowRight className="ml-2 w-4 h-4" />
                  </a>
                </Button>
              </div>
            </motion.div>
